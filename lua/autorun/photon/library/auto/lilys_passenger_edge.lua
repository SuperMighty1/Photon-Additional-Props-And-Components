...
-- This is for the PASSENGER Whelen Inner Edge!
...
local name = "Lilys Passenger Edge"
...
COMPONENT.Positions = {
	...
	[1] = { Vector( -1.6, -8.6, -0.10 ), Angle( 1, 84, 0 ), "auto_viper" }, -- Sixth
    [2] = { Vector( -0.6, -4.8, -0.10 ), Angle( 1, 84, 0 ), "auto_viper" }, -- Fifth
    [3] = { Vector( 0.2, -1.1, -0.10 ), Angle( 1, 84, 0 ), "auto_viper" }, -- Fourth
    [4] = { Vector( 1.2, 2.6, -0.10 ), Angle( 1, 84, 0 ), "auto_viper" }, -- Third
    [5] = { Vector( 1.9, 6.4, -0.18 ), Angle( 1, 84, 0 ), "auto_viper" }, -- Second
    [6] = { Vector( 2.4, 10.3, -0.30 ), Angle( 1, 84, 0 ), "auto_viper_takedown" }, -- First Illumination
